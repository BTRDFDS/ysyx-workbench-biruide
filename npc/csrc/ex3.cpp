...
int main(int argc, char** argv) {
	...
	nvboard_bind_pin(&top->in1,4,SW7,SW6,SW5,SW4);
	nvboard_bind_pin(&top->in2,4,SW3,SW2,SW1,SW0);
    ...
    nvboard_bind_pin(&a,8,DEC0P,DEC1P,DEC2P,DEC3P,DEC4P,DEC5P,DEC6P,DEC7P);
