//ysyx_26020046_rv32iOneHotN
#include "Vysyx_26020046_rv32iOneHotN.h"
#include "verilated.h"
#include <stdlib.h>
#include <unistd.h>
#include <stdio.h>
#include <stdint.h>
#include "svdpi.h"
#include "Vysyx_26020046_rv32iOneHotN__Dpi.h"
#include <time.h>
...
Vysyx_26020046_rv32iOneHotN* top;//顶层模块
svScope scope;//作用域
...
void initDevice(int argc, char** argv){
	...
	top = new Vysyx_26020046_rv32iOneHotN{contextp};
	scope=svGetScopeFromName("TOP.ysyx_26020046_rv32iOneHotN.GPR");
	svSetScope(scope);
