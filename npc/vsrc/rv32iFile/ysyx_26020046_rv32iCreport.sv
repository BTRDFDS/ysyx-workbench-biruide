...
// `define RV32I_DEBUG
	...
	import "DPI-C" function int pmem_read(input int addr,input bit enR);
...
module ysyx_26020046_rv32iLSU(clk,addr,oR2,op,data);
...
//l处理
	...
	assign iRAM = (op.LSU.enL)&clk?pmem_read(addr,op.LSU.enL):0;
