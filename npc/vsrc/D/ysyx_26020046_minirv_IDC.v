module ysyx_26020046_minirv_IDC #(ADDR_WIDTH = 5, DATA_WIDTH = 32)(code,cR1,cR2,cRd,imm,imi,add,addi,lui,l,s,jalr,w,eRd,lbu,lw,sw,sb);
  input [DATA_WIDTH-1:0] code;
  output [ADDR_WIDTH-1:0] cR1,cR2,cRd;
  output add,addi,lui,l,s,jalr,w,eRd,lbu,lw,sw,sb;
