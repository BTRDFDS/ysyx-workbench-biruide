...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %5 = load volatile i32, i32* %1, align 4, !tbaa !5
  %6 = load volatile i32, i32* %2, align 4, !tbaa !5
  %7 = add nsw i32 %6, %5
  %8 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32 noundef %7)
