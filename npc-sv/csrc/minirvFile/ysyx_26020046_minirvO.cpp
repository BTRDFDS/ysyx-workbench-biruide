//ysyx_26020046_minirvO
#include "Vysyx_26020046_minirvO.h"
#include "verilated.h"
#include <stdlib.h>
#include <unistd.h>
#include <stdio.h>
#include <stdint.h>
#include "svdpi.h"
#include "Vysyx_26020046_minirvO__Dpi.h"
#include <time.h>

VerilatedContext* contextp;//verilator上下文
Vysyx_26020046_minirvO* top;//顶层模块
svScope scope;//作用域
...
int main(int argc, char** argv) {
	...
	top = new Vysyx_26020046_minirvO{contextp};
	scope=svGetScopeFromName("TOP.ysyx_26020046_minirvO");
	svSetScope(scope);
