...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 0100011", sb       , S, Mw(src1 + imm, 1, src2&0x00FF));
  INSTPAT("??????? ????? ????? 001 ????? 0100011", sh       , S, Mw(src1 + imm, 2, src2&0xFFFF));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 0110011", sra      , R, R(rd) =  (int32_t)src1 >> (src2&0b11111));
