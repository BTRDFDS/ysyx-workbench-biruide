...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // INSTPAT("0000000 ????? ????? 001 ????? 0110011", sli      ,);
  // INSTPAT("0000000 ????? ????? 010 ????? 0110011", slt      ,);
  // INSTPAT("0000000 ????? ????? 011 ????? 0110011", sltu     ,);
  // INSTPAT("0000000 ????? ????? 100 ????? 0110011", xor      ,);
  // INSTPAT("0000000 ????? ????? 101 ????? 0110011", srl      ,);
  // INSTPAT("0100000 ????? ????? 101 ????? 0110011", sra      ,);
  // INSTPAT("0000000 ????? ????? 110 ????? 0110011", or       ,);
  // INSTPAT("0000000 ????? ????? 111 ????? 0110011", and      ,);
